...
<div id="success_message"> </div>
        <div class="big" id="b5a">
            ...
            <p id="pizzaNamesID" class="pizza names" style=" position:absolute; font-size:30px; margin-top:520px; margin-left:140px; font-family:'cabin sketch'; color:#ff7733; "> CREAMY PASTA  </p>
    <p id="pizzaNamesID" class="pizza names" style=" position:absolute; font-size:30px; margin-top:520px; margin-left:505px; font-family: 'cabin sketch'; color:#ff7733; "> Spicy Chicken Pasta  </p>
    <p id="pizzaNamesID" class="pizza names" style=" position:absolute; font-size:30px; margin-top:520px; margin-left:920px; font-family:'cabin sketch'; color:#ff7733; "> ALFREDO PASTA  </p>
...
<img id="abc123456" src="Assets/pasta1.png" onmouseover="change(this)"  style=" position: absolute; top: 250px; left:100px;  width: 20%; height: 250px; visibility:visible;">
...
<img id="abc123456" src="Assets/pasta4.png" onmouseover="change(this)"  style=" position: absolute; top: 625px; left:100px;  width: 20%; visibility:visible;">
